      ...
      <section className="mx-auto mb-10 max-w-4xl rounded-2xl border border-primary/20 bg-primary/5 p-6 shadow-sm">
        ...
        <div className="mt-5 flex flex-wrap justify-center gap-3 text-sm font-medium">
          <a href="#tips" className="rounded-full bg-primary px-4 py-2 text-primary-foreground shadow-sm transition hover:bg-primary/90">
            {locale === 'zh' ? '直接看技巧' : 'Jump to tips'}
          </a>
          {page.embedGame ? (
            <a href="#play" className="rounded-full border border-primary/30 bg-background px-4 py-2 text-primary transition hover:bg-primary/10">
