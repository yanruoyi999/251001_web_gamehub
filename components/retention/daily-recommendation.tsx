...
export function DailyRecommendation({
  ...
  useEffect(() => {
    ...
    const updatePlacement = () => {
      setPlacementActive(placement === 'desktop' ? desktopQuery.matches : !desktopQuery.matches);
    };
  ...
  return (
    ...
    >
      ...
      <div className={surface === 'home' ? 'grid gap-4 md:grid-cols-3' : 'grid gap-4'}>
            ...
            >
              <div className="relative aspect-[16/9] overflow-hidden bg-emerald-950">
                <Image
                  ...
                  fill
                  sizes={surface === 'home' ? '(max-width: 768px) 100vw, 33vw' : '33vw'}
