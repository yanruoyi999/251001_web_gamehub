...
export const mockGames: MockGame[] = [
  ...
  },
  {
    ...
    slug: 'space-crusade',
    title: '太空远征',
    titleEn: 'Space Crusade',
    description: '驾驶战舰穿越宇宙，躲避陨石并击败敌方舰队。',
    descriptionEn: 'Pilot your craft through space, dodge asteroids, and defeat enemy fleets.',
    iframeUrl: 'https://yanruoyi999.github.io/space-crusade/',
    thumbnailUrl: 'https://via.placeholder.com/400x300/6C5CE7/ffffff?text=Space+Crusade',
    featured: true,
    isNew: true,
    isHot: false,
  },
  ...
  },
  {
    ...
    slug: 'ludum-dare-28',
    title: 'LD28 作品集',
    titleEn: 'Ludum Dare 28',
    description: '体验 Ludum Dare 28 的优秀作品，领略 48 小时创作的魅力。',
    descriptionEn: 'Explore standout Ludum Dare 28 entries created in just 48 hours.',
    iframeUrl: 'https://yanruoyi999.github.io/ludum-dare-28/',
    thumbnailUrl: 'https://via.placeholder.com/400x300/8E44AD/ffffff?text=LD28',
    featured: false,
    isNew: true,
    isHot: false,
  },
  ...
  },
  {
    ...
    slug: 'ludum-dare-29',
    title: 'LD29 深海探险',
    titleEn: 'Ludum Dare 29',
    description: '潜入海底探索 Ludum Dare 29 的奇妙创作。',
    descriptionEn: 'Dive beneath the waves to experience inventive Ludum Dare 29 creations.',
    iframeUrl: 'https://yanruoyi999.github.io/LudumDare29/',
    thumbnailUrl: 'https://via.placeholder.com/400x300/1E3799/ffffff?text=LD29',
    featured: false,
    isNew: true,
    isHot: false,
  },
